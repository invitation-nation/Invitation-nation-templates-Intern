...
import phone from "../assets/Bottom-section/contact-phone.svg";
import location from "../assets/Bottom-section/contact-location.svg";


export default function Bottom(){
    return(
        <div id='content' >
        <section id="bottom-nav-section">
        <div className="nimbus-container">
          <div className="bottom-nav-container">
            <div className="bottom-nav-element">
              <a href="tel:+919986799775">
                <img
                  src={phone}
                  alt=""
                />
